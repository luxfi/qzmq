...
func (c *connection) needsKeyUpdate() bool {
	...
	if !c.opts.KeyRotation.MaxMessages.IsZero() && c.messageCount >= c.opts.KeyRotation.MaxMessages {
		return true
	}
	
	if !c.opts.KeyRotation.MaxBytes.IsZero() && c.byteCount >= c.opts.KeyRotation.MaxBytes {
		return true
	}
...
func (c *connection) getKEM() KEM {
	...
	case HybridX25519MLKEM768:
		return NewHybridKEM(&X25519KEM{}, &MLKEM768{})
	case HybridX25519MLKEM1024:
		return NewHybridKEM(&X25519KEM{}, &MLKEM1024{})
	default:
		return &X25519KEM{}
	}
}
